 ...
 * @author Toonu
 * <p>
 * battleGui.enums representing classes and subclasses of all battleGui.crafts.
 */
...
public enum Type {
    ...
    VERYLARGEAIRFRAME(250, Theatre.AERIAL, "VLH"), CORVETTE(600, Theatre.NAVAL, "FS"),
    FRIGATE(800, Theatre.NAVAL, "FF"), DESTROYER(1000, Theatre.NAVAL, "DD"),
    CRUISER(1200, Theatre.NAVAL, "CC"), BATTLECRUISER(1500, Theatre.NAVAL, "BC"),
    BATTLESHIP(2000, Theatre.NAVAL, "BB"), LIGHTCARRIER(1600, Theatre.NAVAL, "LHD"),
    CARRIER(2500, Theatre.NAVAL, "CV");
    ...
    /**
     * String reperesentation of side.
     *
     * @return side String.
     */
